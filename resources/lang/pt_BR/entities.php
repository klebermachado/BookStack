...
return [
    ...
    'recently_created_shelves' => 'Unidades Recentemente Criadas',
    ...
    'shelf' => 'Unidade',
    'shelves' => 'Unidades',
    'x_shelves' => ':count Unidade|:count Unidades',
    'shelves_long' => 'Unidades de Departamentos',
    'shelves_empty' => 'Nenhuma unidade foi criada',
    'shelves_create' => 'Criar Nova Unidade',
    'shelves_popular' => 'Unidades Populares',
    'shelves_new' => 'Unidades Novas',
    'shelves_new_action' => 'Nova Unidade',
    'shelves_popular_empty' => 'As unidades mais populares aparecerão aqui.',
    'shelves_new_empty' => 'As unidades criadas mais recentemente aparecerão aqui.',
    'shelves_save' => 'Salvar Unidade',
    'shelves_books' => 'Departamentos nesta unidade',
    'shelves_add_books' => 'Adicionar departamentos a esta unidade',
    'shelves_drag_books' => 'Arraste departamentos aqui para adicioná-los a esta unidade',
    'shelves_empty_contents' => 'Esta unidade não possui departamentos atribuídos a ela',
    'shelves_edit_and_assign' => 'Edit shelf to assign books',
    'shelves_edit_named' => 'Editar Unidade de Departamentos :name',
    'shelves_edit' => 'Edit Unidade de Departamentos',
    'shelves_delete' => 'Excluir Unidade de Departamentos',
    'shelves_delete_named' => 'Excluir Unidade de Departamentos :name',
    'shelves_delete_explain' => "A ação vai excluír a unidade de departamentos com o nome ':name'. Departamentos contidos não serão excluídos",
    'shelves_delete_confirmation' => 'Você tem certeza que quer excluir esta unidade de departamentos?',
    'shelves_permissions' => 'Permissões da Unidade de Departamentos',
    'shelves_permissions_updated' => 'Permissões da Unidade de Departamentos Atualizada',
    'shelves_permissions_active' => 'Permissões da Unidade de Departamentos Ativadas',
    'shelves_copy_permissions_to_books' => 'Copiar Permissões para Departamentos',
    'shelves_copy_permissions' => 'Copiar Permissões',
    'shelves_copy_permissions_explain' => 'Isto aplicará as configurações de permissões atuais desta unidade de departamentos a todos os departamentos contidos nela. Antes de ativar, assegure-se de que quaisquer alterações nas permissões desta unidade de departamentos tenham sido salvas.',
    'shelves_copy_permission_success' => 'Permissões da unidade de departamentos copiada para :count departamentos',
    ...
    'books_delete_explain' => 'A ação vai excluír o departamento com o nome \':bookName\'. Todas as páginas e capítulos serão removidos.',
    'books_delete_confirmation' => 'Você tem certeza que quer excluír o Departamento?',
    ...
    'books_empty_contents' => 'Nenhuma página ou capítulo criado para esse departamento.',
    ...
    'books_permissions_active' => 'Permissões do Departamento Ativadas',
    'books_search_this' => 'Pesquisar esse departamento',
    ...
    'chapters_delete_explain' => 'A ação vai excluír o capítulo de nome \':chapterName\'. Todas as páginas do capítulo serão removidas e adicionadas diretamente ao departamento pai.',
    ...
    'profile_not_created_shelves' => ':userName não criou unidades',
