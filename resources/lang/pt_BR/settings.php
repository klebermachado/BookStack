...
return [
    ...
    'role_manage_entity_permissions' => 'Gerenciar todos os serviços, capítulos e permissões de páginas',
    'role_manage_own_entity_permissions' => 'Gerenciar permissões de seu próprio serviço, capítulo e paginas',
    'role_manage_page_templates' => 'Manage page templates',
    'role_manage_settings' => 'Gerenciar configurações de app',
    'role_asset' => 'Permissões de Ativos',
    'role_asset_desc' => 'Essas permissões controlam o acesso padrão para os ativos dentro do sistema. Permissões em Serviço, Capítulos e Páginas serão sobrescritas por essas permissões.',
